<div id="main_header">
	<div class="main_list_left">
		<ul>
			<li><a href="game.php?page=changelog" style="color: lime; font-weight: bold;">V2.1.2</a></li>
	...
	<div class="main_list_right">
		<ul>
			...
			{if !empty($hasBoard)}<li><a href="/forum" target="forum" target="_blank"><i class="fas fa-comment-alt"></i></a></li>{/if}
