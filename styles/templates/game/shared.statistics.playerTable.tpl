...
<tr>
	...
	<td>{if $RangeInfo.id != $CUser_id}<a href="#" onclick="return Dialog.PM({$RangeInfo.id});"><i class="far fa-envelope" title="{$LNG.st_write_message}" style="font-size: 15px;"></i></a>{/if}</td>
