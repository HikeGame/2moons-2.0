...
{block name="content"}
    <div class="content_page">
        {if $authlevel >= 3}
            <div class="col-lg-12 overview_player_admin center">
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-3">
                        {if $AdminsOnline|number > 0}
                            <a href="game.php?page=ticket"><i class="fas fa-ticket-alt green"></i> {$LNG.ov_ticket}</a>
                        {else}
                            <a href="game.php?page=ticket"><i class="fas fa-ticket-alt red"></i> {$LNG.ov_ticket}</a>
                        {/if}
                    </div>
                </div>
            </div>
        ...
        {*<div class="title">
            ...
            <span>
			<i class="fas fa-users"></i> {$LNG.ov_admins_online} : {foreach $AdminsOnline as $ID => $Name}{if !$Name@first}&nbsp;&bull;&nbsp;{/if}
                    <a href="#"
                       onclick="return Dialog.PM({$ID})">{$Name}</a>{foreachelse}{$LNG.ov_no_admins_online}{/foreach}
		</span>
            <div class="ticket">
                <a href="game.php?page=ticket"><i class="fas fa-ticket-alt green"></i> {$LNG.ov_ticket}</a>
            </div>
        ...
        <div class="" style="">
            <div id="contentPlanet"
                ...
                {if $planet_type == 1}
                    <div id="lunePlanet">
                        {if $Moon}<a href="game.php?page=overview&amp;cp={$Moon.id}&amp;re=0" title="{$Moon.name}"><i
