                            ...
                            <div class="build-data">
                                    ...
                                    <div class="block_construct_desc_list">
                                        {foreach $Element.costResources as $RessID => $RessAmount}
                                            <div style="margin-bottom: 10px;">
                                                <img src="{$dpath}images/{$RessID}.png" alt="">
                                                <b>
                                        ...
                                        {if !empty($Element.infoEnergy)}
                                            <div>{$LNG.bd_next_level}</div>
                                            <div>{$Element.infoEnergy}</div>
                                        {/if}
                                ...
                                <div class="build-data_button">
                                    ...
                                    {if $Element.maxLevel == $Element.levelToBuild}
                                        <div class="build-data--build-button red">
                                            <span>{$LNG.bd_maxlevel}</span>
                                        </div>
                                    ...
                                    {else}
                                        ...
                                        {if $CanBuildElement && $Element.buyable}
                                            <form action="game.php?page=buildings" method="post" class="build_form">
                                                    ...
                                                    <input type="hidden" name="building" value="{$ID}">
                                                    <button type="submit"
                                                            class="build-data--build-button">{if $Element.level == 0}{$LNG.bd_build}{else}{$LNG.bd_build_next_level}{$Element.levelToBuild + 1}{/if}</button>
                                                </form>
                                            {else}
                                                <div class="build-data--build-button red">
                                                    <span>{if $Element.level == 0}{$LNG.bd_build}{else}{$LNG.bd_build_next_level}{$Element.levelToBuild + 1}{/if}</span>
                                                </div>
                                        {/if}
                                        {else}
                                            <div class="build-data--build-button red">
            ...
            <div class="main_construct">
                <div class="block_construct">
                    <div class="title" style="margin: 5px 0 0 -5px; text-align: left;">
                        <a href="#" onclick="return Dialog.info({$ID})">
                            <img src="{$dpath}gebaeude/{$ID}.gif" alt="{$LNG.tech.{$ID}}" width="20" height="20">
                            {$LNG.tech.{$ID}} {if $Element.level > 0} - {$LNG.bd_lvl} {$Element.level}
                                {if $Element.maxLevel != 255}/{$Element.maxLevel}{/if}
                            {/if}
                        </a>
                                ...
                                {if $RoomIsOk}
                                    {if $CanBuildElement && $Element.buyable}
                                        <form action="game.php?page=buildings" method="post" class="build_form">
                                            ...
                                            <input type="hidden" name="building" value="{$ID}">
                                            <button type="submit"
                                                    class="build_submit construct_button">{if $Element.level == 0}{$LNG.bd_build}{else}{$LNG.bd_build_next_level}{$Element.levelToBuild + 1}{/if}</button>
                                        </form>
                                    {else}
                                        <div class="construct_button_lost">
