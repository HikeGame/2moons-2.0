...
$LNG['bad_forum_url']     = 'No hay URL de Foro definida!';
...
$LNG['ov_newname_specialchar']           = 'Los nombres planeta sólo números, letras, espacios, son _, -,. permitidos!';
$LNG['ov_newname_done']                  = 'Planeta renombrado con éxito!';
...
$LNG['gl_inactive_seven']              = '7 Días inactivo';
$LNG['gl_inactive_twentyeight']        = '28 Días inactivo';
$LNG['gl_short_strong']                = 'F';
$LNG['gl_short_newbie']                = 'D';
...
//----------------------------------------------------------------------------//
//PHALANX
$LNG['px_no_deuterium']   = '¡Usted no posee suficiente deuterio!';
...
//----------------------------------------------------------------------------//
//IMPERIUM
$LNG['lv_imperium_title'] = 'Visualización del Imperio';
$LNG['lv_planet']         = 'Planeta';
$LNG['lv_name']           = 'Nombre';
$LNG['lv_coords']         = 'Coordenadas';
$LNG['lv_fields']         = 'Campos';
$LNG['lv_resources']      = 'Recursos';
$LNG['lv_buildings']      = 'Estructuras';
$LNG['lv_technology']     = 'Tecnologías';
$LNG['lv_ships']          = 'Naves';
$LNG['lv_defenses']       = 'Defensas';
$LNG['lv_total']          = 'Total';
...
$LNG['fl_modify_sac_name']          = 'Nombre del SAC';
...
$LNG['bd_building_shipyard']          = 'No puedes fabricar durante la ampliaci&oacute;n del hangar, f&aacute;brica de robots o nanobots';
$LNG['bd_available']                  = 'Disponible: ';
$LNG['bd_build_ships']                = 'Construir';
$LNG['bd_protection_shield_only_one'] = '¡La Cúpula de protecci&oacute;n s&oacute;lo se puede construir una vez!';
$LNG['bd_build_defenses']             = 'Construir';
$LNG['bd_actual_production']          = 'Producci&oacute;n actual:';
$LNG['bd_completed']                  = 'Completado';
$LNG['bd_operating']                  = 'En funcionamiento';
$LNG['bd_continue']                   = 'Continuar';
$LNG['bd_price_for_destroy']          = 'Coste de destrucci&oacute;n:';
$LNG['bd_ready']                      = 'Listo';
...
$LNG['sys_buildlist_fail']            = 'Fallo en la lista de construcción';
...
//----------------------------------------------------------------------------//
//INFOS
$LNG['in_jump_gate_done']             = 'El salto cuántico fue realizado, el próximo salto podrá ser realizado en: %s';
...
$LNG['al_not_exists']                   = 'La alianza no existe.';
$LNG['al_newname_specialchar']          = 'El nombre de la alianza y la fecha son sólo números, letras, espacios, _, -,. permitido!';
...
$LNG['al_rank_desc']['KICK']            = 'Puede expulsar a los miembros';
...
$LNG['bu_new_request_title']       = 'Nueva solicitud de amigos!';
$LNG['bu_new_request_body']        = 'Hola %s,<br>%s usted tiene enviada una solicitud-lista de amigos!';
$LNG['bu_accepted_request_title']  = 'Solicitud de Amistad aceptada!';
$LNG['bu_accepted_request_body']   = 'Hola %s,<br>%s acepta su solicitud de Amistad!';
$LNG['bu_rejected_request_title']  = 'Rechazada solicitud de Amistad!';
$LNG['bu_rejected_request_body']   = 'Hola %s,<br>%s rechazó su solicitud de amistad!';
...
$LNG['op_active_build_messages']          = 'Mensajes cola Edificios';
$LNG['op_active_spy_messages_mode']       = 'Mensajes de Espionajes Resumidos';
$LNG['op_dst_mode']                       = 'Horario de Verano?';
...
$LNG['bn_players_banned_list'] = 'Lista de jugadores sancionados';
...
$LNG['css_account_banned_expire']  = 'Por esta razón %s estás sancionado.<br><a href="./index.php?page=pranger">Sancionados</a>';
...
$LNG['cff_mission_own_expo_0']  = 'Una %s de %s %s %s se dirige a %s. Misi&oacute;n: %s';
$LNG['cff_mission_own_expo_1']  = 'Una %s Vuelve de %s  hacia %s %s %s. Misi&oacute;n: %s';
...
$LNG['ti_id']            = 'Ticket';
$LNG['ti_username']      = 'Usuario';
$LNG['ti_subject']       = 'Asunto';
$LNG['ti_status']        = 'Estatus';
$LNG['ti_date']          = 'Fecha';
...
$LNG['ti_create_info'] = '<p>Por favor, perdóname. Al crear un nuevo Ticket de una línea de asunto descriptivo y explique sus preocupaciones con tanto detalle como sea posible.</p>
<p>Una descripción detallada de su problema o duda permite cortos tiempos de procesamiento y evita que se consuma mucho tiempo en preguntas de ida y vuelta..</p>
<p>cuestiones relacionadas con la cuenta, facilita la especificación de las cuentas de los clientes adecuados y la asignación también reduce el tiempo de procesamiento .</p>';
$LNG['ti_create_head'] = 'Nuevo Ticket';
$LNG['ti_category']    = 'Categoría';
$LNG['ti_subject']     = 'Asunto';
$LNG['ti_message']     = 'Mensaje';
$LNG['ti_submit']      = 'Enviar';
$LNG['ti_read']        = 'Leer Ticket';
$LNG['ti_answer']      = 'Responder';
$LNG['ti_create']      = 'Ticket creado en';
$LNG['ti_responded']   = 'Ticket respondido en ';
$LNG['ti_not_exist']   = 'El Ticket #%d no existe!';
$LNG['ti_from']        = 'desde';
$LNG['ti_re']          = 'RE:';
...
$LNG['bs_techno']        = "Tecnolog&iacute;a";
$LNG['bs_send']          = "Enviar";
...
$LNG['ft_empty']    = '¡No posees ninguna nave para comerciar con el Mercader!';
...
// comerciantes
// ------------------------------------------------ --------------------------------------------------------- //
$LNG['trade_NotEnoughResources']  = "No hay suficientes recursos disponibles";
$LNG['trade_BuyLesserThanZero']   = "Está bien, menos de cero. Le acreditaremos la cantidad. Nunca... ingrese algo sensato.";
$LNG['trade_BuyEmptyOrZero']      = "No puede simplemente comprar %s %s. Debería ser al menos %s %s.";
$LNG['trade_TradersGone']         = "El comerciante se ha ido a saco y equipaje.";
$LNG['trade_PleaseWait']          = "Debe esperar un momento antes de hacer esto.";
$LNG['trade_BuyTooMuch']          = "No puede comerciar más de lo que permite comerciar.";
$LNG['trade_PlanetManipulation']  = "Conseguiste rápidamente los recursos de un planeta extraño.<br />Desafortunadamente, te observaron.";
$LNG['trade_Success']             = "Pudiste intercambiar con éxito %s %s por %s %s.";
$LNG['trade_for']                 = "contra";
$LNG['trade_AmountToTrade']       = "¿Cuánto quiere?";
$LNG['trade_buy']                 = "comprar";
$LNG["trade_SendToTraderSuccess"] = "%s %s han sido enviados.";
$LNG["trade_getPerResource"]      = "y obtener por recurso:";
$LNG["trade_Intro"]               = "¿Necesita recursos? Entonces ha venido al lugar correcto. Todo está <strike>bien</strike> aquí
                    ... caro, siempre lejos y de calidad inferior.";
$LNG["trade_InfoText"]            = "Ingrese aquí cuántos recursos desea vender y cuánto desea obtener de qué recurso.<br />
                        Según su tipo de cambio, el tipo de los recursos bajará o subirá. Él nunca será el mismo. Así que ten cuidado
                        si todavía quiere precios razonables mañana, actúe también con sensatez.<br />
                        La tasa inicial era 1:2:3. El curso fluctúa diariamente.<br />
                        Los jugadores pueden comprar todo a la vez, pero no es necesario.<br />
