...
// Trader
// ---------------------------------------------------------------------------- //
$LNG['trade_NotEnoughResources']  = "Nicht genügend Resourcen vorhanden";
$LNG['trade_BuyLesserThanZero']   = "Okay, weniger als Null. Wir werden dir den Betrag gutschreiben. Niemals ... gib was vernünftiges ein.";
$LNG['trade_BuyEmptyOrZero']      = "Du kannst nicht nur %s %s kaufen. Es sollten mindestens %s %s sein.";
$LNG['trade_TradersGone']         = "Der Händler hat sich mit Sack und Pack in Luft aufgelöst.";
$LNG['trade_PleaseWait']          = "Du solltest damit noch einen Augenblick warten.";
$LNG['trade_BuyTooMuch']          = "Du kannst nicht mehr handeln, als der Handel hergibt.";
$LNG['trade_PlanetManipulation']  = "Du holst die Resourcen schnell von einem dir fremden Planeten.<br />Leider wurdest du dabei beobachtet.";
$LNG['trade_Success']             = "Du konntest erfolgreich %s %s gegen %s %s eintauschen.";
$LNG['trade_for']                 = "gegen";
$LNG['trade_AmountToTrade']       = "Wieviel möchtest du ?";
$LNG['trade_buy']                 = "kaufen";
$LNG["trade_SendToTraderSuccess"] = "%s %s wurden verschickt.";
$LNG["trade_getPerResource"]      = "und erhalte pro Resource:";
$LNG["trade_Intro"]               = "Du brauchst Resourcen ? Dann bist du hier genau richtig. Hier ist einfach alles <strike>gut</strike>
                    ... teuer, ewig weit weg und von minderer Qualität.";
$LNG["trade_InfoText"]            = "Du gibst hier an, wieviele Resourcen du verkaufen möchtest und wieviel du von welcher Resource du bekommen möchtest.<br />
                        Anhand  deines Tauschkurses fällt oder steigt der Kurs für Resourcen. Er wird nie gleich sein. Gib also darauf acht,
                        willst du morgen noch vernünftige Preise, handle auch vernünftig.<br />
                        Der Anfangskurs war 1:2:3. Der Kurs schwankt täglich.<br />
