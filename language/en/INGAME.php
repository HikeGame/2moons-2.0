...
$LNG['rs_metal']                = 'Metal';
$LNG['rs_crystal']              = 'Crystal';
$LNG['rs_deuterium']            = 'Deuterium';
$LNG['rs_darkmatter']           = 'Dark Matter';
...
$LNG["starsysteminfo"] = "The page loads a little longer because of the many systems and information. Give it some time";

// Trader
// ---------------------------------------------------------------------------- //
// traders
// ------------------------------------------------ ------------------------------------------ //
$LNG['trade_NotEnoughResources']  = "Not enough resources available";
$LNG['trade_BuyLesserThanZero']   = "Okay, less than zero. We'll credit you with the amount. Never... enter something sensible.";
$LNG['trade_BuyEmptyOrZero']      = "You can't just buy %s %s. It should be at least %s %s.";
...
$LNG['trade_AmountToTrade']       = "How much do you want ?";
$LNG['trade_buy']                 = "buy";
$LNG["trade_SendToTraderSuccess"] = "%s %s have been sent.";
$LNG["trade_getPerResource"]      = "and get per resource:";
$LNG["trade_Intro"]               = "You need resources? Then you've come to the right place. Everything is <strike>good</strike> here
                    ... expensive, forever far away and of inferior quality.";
$LNG["trade_InfoText"]            = "You enter here how many resources you want to sell and how much you want to get from which resource.<br />
                        Based on your exchange rate, the rate for resources will fall or rise. He will never be the same. So take care
                        if you still want sensible prices tomorrow, act sensibly too.<br />
                        The initial rate was 1:2:3. The course fluctuates daily.<br />
                        Players can buy everything at once, but don't have to.<br />
                        When buying you can specify how much you want to buy. Resources are (still) credited immediately.";
$LNG["trade_BetaTest"]            = "BETA - User Test";
$LNG["trade_ownTrade"]            = "own trade";
$LNG["trade_SellerMessageText"]   = "A ship from <b>%s</b> docked at the trading post and picked up %s %s for %s %s.";
$LNG["trade_BuyerMessageText"]    = "Your ship docked at the trading post and picked up %s %s for %s %s.";