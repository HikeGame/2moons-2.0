...
$LNG['button_reset']		= 'Resetar';
$LNG['button_des_se']		= 'Selecionar tudo ou desmarcar';
//###########################################################//


//---------------	ID's	------------------------//
$LNG['input_id']			= 'ID';
$LNG['input_id_user']		= 'ID do Jogador';
$LNG['input_id_planet']		= 'ID do Planeta';
$LNG['input_id_moon']		= 'ID da Lua';
$LNG['input_id_p_m']		= 'ID do Planeta ou Lua';
$LNG['input_id_ally']		= 'ID da Aliança';
//###########################################################//
...
$LNG['ad_editor_authlevels']	= 'Permissões';
...
//	Aliança
$LNG['ad_ally_title']		= 'Alianças';
$LNG['ad_ally_change_id']	= 'Modificar ID da Aliança';
$LNG['ad_ally_name']		= 'Nome da Aliança';
$LNG['ad_ally_tag']			= 'TAG da Aliança';
$LNG['ad_ally_text1']		= 'Descrição da Aliança';
$LNG['ad_ally_text2']		= 'Texto Interno';
$LNG['ad_ally_text3']		= 'Modelo de Aplicação';
$LNG['ad_ally_delete']		= 'Excluir aliança';
...
$LNG['ad_pla_edit_name']		= 'Nome';
$LNG['ad_pla_change_id']		= 'Mudar ID do Planeta';
$LNG['ad_pla_edit_diameter']	= 'Editar diâmetro';
$LNG['ad_pla_edit_fields']		= 'Editar campos';
$LNG['ad_pla_delete_b']			= 'Remover todos os edificios';
$LNG['ad_pla_delete_s']			= 'Remover todas as naves';
$LNG['ad_pla_delete_d']			= 'Remover todas as defesas';
$LNG['ad_pla_delete_hd']		= 'Remover lista de espera do Hangar';
$LNG['ad_pla_delete_cb']		= 'Remover lista de construção';
$LNG['ad_pla_delete_planet']	= 'Eliminar planeta';
$LNG['ad_pla_title_a']			= 'Se o planeta possui uma lua, poderá ser permitido a mudança de ID';  // ???
$LNG['ad_pla_title_l']			= 'Se a lua é existente, as suas coordenadas também serão alteradas';
$LNG['ad_pla_change_p']			= 'Coordenadas de Planetas';
$LNG['ad_pla_change_pp']		= 'Acento para fazer mudança de coordenadas';  // ???
$LNG['ad_pla_succes']			= 'Alterações feitas com sucesso';
$LNG['ad_pla_error_planets']	= 'As luas não podem mudar de coordenadas';
$LNG['ad_pla_error_user']		= 'O jogador não existe!';
$LNG['ad_pla_error_planets2']	= 'O planeta não existe';
$LNG['ad_pla_error_planets3']	= 'As coordenadas estão em uso!';
$LNG['ad_pla_error_planets4']	= 'Não pode modificar o planeta se ja possui lua!';
$LNG['ad_pla_error_planets5']	= 'Existe um planeta nas mesmas coordenadas';
$LNG['ad_pla_delete_planet_s']	= 'Planeta removido com sucesso';
//###########################################################//
...
$LNG['bo_banned']				= 'Banido com sucesso';
$LNG['bo_unbanned']				= 'Desbanido com sucesso';  // [Sperre aufgehoben ?]
$LNG['bo_username']				= 'Username';
$LNG['bo_vacaations']			= 'Modo de férias';
$LNG['bo_reason']				= 'Motivo de BAN';
$LNG['bo_time']					= 'Duração de repreensão';
$LNG['bo_vacation_mode']		= 'Modo de férias';
$LNG['bo_ban_player']			= 'Desbanir / banir';
$LNG['bo_unban_player']			= 'Lista de Suspensão';
$LNG['bo_user_doesnt_exist']	= 'Este jogador não existe!';
$LNG['bo_user_select']			= 'Selecionar...';
$LNG['bo_select_title']			= 'Mostrar nomes começados em';
$LNG['bo_suspended_panel']		= 'Painel de Suspensão';
$LNG['bo_bbb_go_back']			= '[ Voltar ]';
$LNG['bo_bbb_go_act']			= '[ Recarregar ]';
...
$LNG['bo_total_users']			= 'Total de jogadores: ';
$LNG['bo_total_banneds']		= 'Jogadores suspensos: ';
$LNG['bo_ban']					= 'Bloqueados';
$LNG['bo_unban']				= 'Desbloquear';
//###########################################################//
...
$LNG['cs_time_between_updates']			= 'Tempo entre as atualizações';
...
$LNG['cs_save_changes']					= 'Guardar';
$LNG['cs_timeact_1']					= 'A última atualização foi em: ';
$LNG['cs_yes']							= 'Sim';
$LNG['cs_no']							= 'Não';
$LNG['cs_no_view']                      = 'Não exibir admins';
...
$LNG['se_server_parameters']			= 'Configurações do Universo';
...
$LNG['se_metal_production']				= 'Produção básica de Metal';
$LNG['se_crystal_production']			= 'Produção básica de Cristal';
$LNG['se_deuterium_production']			= 'Produção básica de Deutério';
$LNG['se_several_parameters']			= 'Vários parãmetros';
$LNG['se_title_admins_protection']		= 'Quando esta função é ativada, os Administradores ou Moderadores não são atacados';
$LNG['se_admin_protection']				= 'Proteção de Administração';
$LNG['se_debug_mode']					= 'Debug mode';
$LNG['se_save_parameters']				= 'Guardar';
$LNG['se_configuration_title']			= 'Configuração do Servidor';
$LNG['se_server_naame']					= 'Nome do jogo';
$LNG['se_cookie_name']					= 'Nome de Cookie';
...
$LNG['se_recaptcha_desc']               = 'RECAPTCHA CAPTCHA é um serviço gratuito que irá ajudar a bloquear spam e bots.';
$LNG['se_recaptcha_public']             = 'Chave Pública:';
$LNG['se_recaptcha_private']            = 'Chave Privada:';
$LNG['se_recaptcha_active']             = 'Ativar RECAPTCHA';
...
$LNG['se_del_user_automatic']			= 'Excluir os inativos';
$LNG['se_del_user_automatic_info']		= 'Exclui os usuários que não logou na conta por inatividade, após X dias.';
...
$LNG['se_server_colonisation_config'] 	= 'Configuração de Colonias';
$LNG['se_planets_min'] 					= 'Máximo de planetas sem qualquer pesquisa';
...
$LNG['se_ref_active']					= 'Ativar Referallink';
...
$LNG['se_news_info']                    = 'Se desativares, as notícias já não seram visiveis na vista geral.';
...
$LNG['se_smtp_ssl_info']                = 'Aqui poderás escolher que tipo de ligação queres que seja feita!';
...
$LNG['se_max_planets_info']             = 'Numero máximo de campo de Planetas para que se possa colonizar (Por defeito:15)';
$LNG['se_min_player_planets']           = 'Máximo de Planetas';
$LNG['se_max_player_planets_info']      = 'Máximo de planetas Sem evoluir a Exploração Espacial';
$LNG['se_max_player_planets']           = 'Máximo de Planetas com Exploração';
$LNG['se_min_player_planets_info']      = 'Numero máximo de colonias com a pesquisa';
$LNG['se_planet_factor']                = 'Tamanho do Planeta.';
$LNG['se_planet_factor_info']           = 'Multiplicador do tamanho do Planeta';
$LNG['se_max_elements_build']           = 'Max. Construcção - Edificios';
$LNG['se_max_elements_build_info']      = 'Numero máximo de edificios na fila de construcção';
$LNG['se_max_elements_tech']            = 'Max. Construcção - Pesquisas';
$LNG['se_max_elements_tech_info']       = 'Numero máximo de pesquisas na fila de construcção';
$LNG['se_max_elements_ships']           = 'Max. Construcção - Hangar';
$LNG['se_max_elements_ships_info']		= 'Numero máximo de frotas na fila que possa ser construido no Hangar';
$LNG['se_max_fleet_per_build']          = 'Max. Fleets / Pedidos';
$LNG['se_max_fleet_per_build_info']     = 'Numero máximo de unidades por ordem no Hangar';
$LNG['se_max_overflow']                 = 'Memória Overflow';
$LNG['se_max_overflow_info']            = 'Fator, quantos recursos podem ser produzidos com rolamentos completa';
$LNG['se_moon_factor']                  = 'Chance de Lua';
$LNG['se_moon_factor_info']             = 'Fator de Chance de criação de Lua';
$LNG['se_moon_chance']                  = 'Máx. Chance de Lua';
$LNG['se_moon_chance_info']             = 'Máxima chance de origem lunar';
$LNG['se_darkmatter_cost_trader']       = 'Custo do Mercador';
$LNG['se_darkmatter_cost_trader_info']  = 'Pagamento de Matéria Negra para ir ao Mercador';
$LNG['se_factor_university']            = 'Fator de universidade';
$LNG['se_factor_university_info']       = 'Percentagem de redução de tempo de pesquisas da Universidade';
$LNG['se_max_fleets_per_acs']           = 'Max. Frota / ACS (Ataque em Cooperação)';
$LNG['se_max_fleets_per_acs_info']      = 'Máximo numero de frotas em ACS (Defeito - 16)';
$LNG['se_vmode_min_time']               = 'Modo de Férias';
$LNG['se_vmode_min_time_info']          = 'Tempo que o jogador está em férias no Minimo em segundos';
$LNG['se_gate_wait_time']               = 'Portal Quantico';
$LNG['se_gate_wait_time_info']          = 'Tempo entre intervalos do Portal Quantico em segundos (Defeito - 3600)';
$LNG['se_metal_start']                  = 'Inicio - Metal';
$LNG['se_metal_start_info']             = 'Recursos iniciais de Metal para novo jogador.';
$LNG['se_crystal_start']                = 'Inicio - Cristal';
...
$LNG['se_darkmatter_start']             = 'Inicio - Matéria Negra';
...
//---------------	Moderação	------------------------//
//	Permissões
$LNG['mod_title'] 						= 'Permissões de Administrador';
$LNG['mod_range'] 						= 'Autoridade';
...
$LNG['mod_power_loog']			        = 'Log de Ações';

//	Niveis de Autoridade
$LNG['ad_authlevel_title']              = 'Autoridades';
...
$LNG['ff_ships']				= "Naves";
$LNG['ff_startuser']			= "Remetente";
$LNG['ff_startplanet']			= "Planeta remetente";
$LNG['ff_arrivaltime']			= "Tempo de inicio";
$LNG['ff_targetuser']			= "Destinatário";
$LNG['ff_targetplanet']			= "Planeta destinatário";
...
$LNG['sb_stats_update']					= 'Estatísticas atualizadas em: %t segundos<br>';
...
$LNG['mu_settings'] 					= 'Configuração do Jogo';
$LNG['mu_unisettings']                  = 'Configuração do Universo';
...
$LNG['mu_error_list'] 					= 'Erros na Base de Dados';
$LNG['mu_active_planets'] 				= 'Planetas Ativos';
...
$LNG['vt_head']						= 'Verificar os ficheiros do jogo';
$LNG['vt_filephp']					= 'Ficheiro PHP';
$LNG['vt_filetpl']					= 'Ficheiro Template';
$LNG['vt_filecss']					= 'Ficheiro CSS';
$LNG['vt_filejs']					= 'Ficheiro Java Script';
$LNG['vt_fileimg']					= 'Ficheiro de Imagens';
$LNG['vt_filehtaccess']				= 'Ficheiro HTACESS';
$LNG['vt_all']						= 'Todos os Ficheiros';
$LNG['vt_fileok']					= 'Ficheiro Ok';
$LNG['vt_filefail']					= 'Ficheiro Alterado';
$LNG['vt_filenew']					= 'Novo Ficheiro';
$LNG['vt_fileerror']				= 'Erro';
$LNG['vt_loadfile']					= 'Carregar lista de ficheiros';
...
$LNG['re_reset_hangar'] 				= 'Reiniciar hangar e defesas em fila';
...
$LNG['re_resources_dark'] 				= 'Reiniciar a Materia Negra';
$LNG['re_resources_met_cry'] 			= 'Reiniciar todos os recursos (Metal/Cristal/Deutério)';
$LNG['re_general'] 						= 'Geral';
$LNG['re_reset_moons'] 					= 'Apagar TODAS Luas';
$LNG['re_reset_notes'] 					= 'Apagar TODAS Notas';
$LNG['re_reset_rw'] 					= 'Apagar TODOS Relatorios de Batalha';
$LNG['re_reset_buddies'] 				= 'Reiniciar a Lista de Amigos';
$LNG['re_reset_allys'] 					= 'Apagar TODAS as Alianças';
$LNG['re_reset_fleets'] 				= 'Apagar TODAS as frotas em Vôo';
$LNG['re_reset_errors'] 				= 'Reiniciar a Lista de Erros';
$LNG['re_reset_banned'] 				= 'Reiniciar os Bans';
$LNG['re_reset_messages'] 				= 'Apagar TODAS as Mensagens';
$LNG['re_reset_statpoints'] 			= 'Reiniciar as Estatisticas';
$LNG['re_reset_all'] 					= 'REINICIAR TODO O UNIVERSO';
...
$LNG['ac_select_id_num']                = 'Escreve o ID manualmente (Opcional)';
$LNG['ac_select_username']              = 'Escolhe o Jogador';
...
$LNG['ac_moon']                         = 'Lua';
$LNG['ac_enter_user_id']                = 'Selecione o Jogador';
...
$LNG['ac_act_time']                     = 'Data da ultima atividade';
...
$LNG['se_inactives'] 					= 'Inativo';
$LNG['se_planets_act']	                = 'Planetas ativos';
...
$LNG['se_input_activity'] 				= 'Atividade';
...
$LNG['se_input_a'] 						= 'A';
$LNG['se_input_d'] 						= 'D';
$LNG['se_input_hay'] 					= 'Então neste momento';
$LNG['se_input_inact'] 					= 'inativo/s';
...
$LNG['se_input_act_pla']	            = ' Planeta/s ativo/s';
...
$LNG['se_search_users_1']				=	'Nome';
$LNG['se_search_users_2']				=	'E-mail';
$LNG['se_search_users_3']				=	'Ultima atividade';
$LNG['se_search_users_4']				=	'Data de registo';
$LNG['se_search_users_5']				=	'Ultimo IP';
$LNG['se_search_users_6']				=	'Autoridade';
$LNG['se_search_users_7']				=	'Suspendido?';
$LNG['se_search_users_8']				=	'Férias?';

// Pesquisa na tabela de Planetas
$LNG['se_search_planets_0']			=	'ID';
$LNG['se_search_planets_1']			=	'Nome';
$LNG['se_search_planets_2']			=	"Dono";
$LNG['se_search_planets_3']			=	"Ultima atividade";
$LNG['se_search_planets_4']			=	"Galáxia";
$LNG['se_search_planets_5']			=	"Sistema";
$LNG['se_search_planets_6']			=	"Planeta";
$LNG['se_search_planets_7']			=	"Tem Lua?";

// Pesquisa na tabela de Jogadores banidos
$LNG['se_search_banned_0']				=	'ID';
$LNG['se_search_banned_1']				=	'Nome';
$LNG['se_search_banned_2']				=	"Data de suspensão";
$LNG['se_search_banned_3']				=	"Data de reativação";
$LNG['se_search_banned_4']				=	"Razão";
$LNG['se_search_banned_5']				=	"Autor";

// Pesquisa na tabela de Alianças
$LNG['se_search_alliance_0']			=	'ID';
$LNG['se_search_alliance_1']			=	'Nome';
$LNG['se_search_alliance_2']			=	"TAG";
$LNG['se_search_alliance_3']			=	"Administrador";
$LNG['se_search_alliance_4']			=	"Data de criação";
$LNG['se_search_alliance_5']			=	"Numero de membros";
//###########################################################//
...
$LNG['new_creator_title_u']	            = 'Criar/Apagar Usários';
...
$LNG['new_creator_refresh']	            = '[ Atualizar ]';

//	Usários
$LNG['new_title']			= 'Criar novo jogador';
$LNG['new_user_success']	= 'Jogador criado com sucesso!';
$LNG['new_add_user']		= 'Adicionar novos jogadores';
$LNG['new_range']			= 'Rank';
...
$LNG['po_add_planet']				= 'Adicionar Colónia';
$LNG['po_name_planet']				= 'Nome do Planeta';
$LNG['po_complete_all']				= 'Dados inválidos ou existentes!';
$LNG['po_complete_all2']			= 'Erro nas coordenadas!';
$LNG['po_complete_succes']			= 'Planeta criado com sucesso';

//	Luas
$LNG['mo_moon_added']				= 'Lua adicionada com sucesso!';
$LNG['mo_moon_unavaible']			= 'O planeta já possui lua!';
$LNG['mo_moon_random']				= 'Random';
$LNG['mo_planet_doesnt_exist']		= 'O jogador não existe!';
$LNG['mo_moon_name']				= 'Nome da lua';
$LNG['mo_moon']						= 'Lua';
$LNG['mo_diameter']					= 'Diâmetro';
$LNG['mo_fields_avaibles']			= 'Campos';
$LNG['po_add_moon']					= 'Adicionar lua';
//###########################################################//
...
$LNG['qe_planetname']					= 'Planeta';
$LNG['qe_level']						= 'Nivel';
$LNG['qe_count']						= 'Disponivel';
$LNG['qe_input']						= 'Editar';
$LNG['qe_edit_planet_sucess']			= 'Planeta %s [%d:%d:%d] editado com sucesso!';
$LNG['qe_edit_player_sucess']			= 'Jogador %s (ID: %d) editado com sucesso!';
...
$LNG['modul_0']                        = 'Aliança';
$LNG['modul_2']                        = 'Construção - Edificios';
$LNG['modul_3']                        = 'Construção - Pesquisas';
...
$LNG['modul_11']                       = 'Galáxia';
$LNG['modul_12']                       = 'Fama';
$LNG['modul_13']                       = 'Controlo';
$LNG['modul_14']                       = 'Infos';
$LNG['modul_15']                       = 'Imperio';
$LNG['modul_42']						= 'Missão - ACS';
$LNG['modul_32']                       = 'Missão - Reduzir';
$LNG['modul_1']                        = 'Missão - Atacar';
$LNG['modul_31']                       = 'Missão - Exploração de MN';
$LNG['modul_30']                       = 'Missão - Exploração';
$LNG['modul_33']                       = 'Missão - Manter posições';
$LNG['modul_35']                       = 'Missão - Colonização';
$LNG['modul_24']                       = 'Missão - Espiar';
$LNG['modul_36']                       = 'Missão - Estação';
$LNG['modul_34']                       = 'Missão - Transporte';
...
$LNG['modul_22']                       = 'Recordes';
$LNG['modul_23']                       = 'Comodidades';
$LNG['modul_25']                       = 'Estatisticas';
$LNG['modul_37']                       = 'Banner';
...
$LNG['mod_deactive']					= 'Inativo';
$LNG['mod_change_active']				= 'Ativado';
$LNG['mod_change_deactive']				= 'Desativado';

// Noticias

$LNG['nws_news']						= 'Noticias';
$LNG['nws_head_create']					= 'Criar nova noticia';
...
$LNG['nws_create']						= 'A criar noticia';
$LNG['nws_total']						= 'Total %d noticias Disponiveis';
...
$LNG['mvc_link']						= 'Link';
$LNG['mvc_update_yes']					= 'Uma atualização esta disponivel!';
$LNG['mvc_update_no']					= 'Ultima versão instalada!';
$LNG['mvc_update_version']				= 'Versão Atual';
...
$LNG['up_update_ok_rev']				= 'Atualizado até à revisão: ';
$LNG['up_download_patch_files']			= 'Download do Patch';
$LNG['up_aktuelle_updates']				= 'Atualizações Atuais';
$LNG['up_momentane_version']			= 'Versão atual';
$LNG['up_alte_updates']					= 'Atualizações antigas';
$LNG['up_revision']						= 'Revisão ';
$LNG['up_add']							= 'Adicionado em:';
$LNG['up_edit']							= 'Editado em:';
...
// Giveaway
$LNG['ga_success']						= 'Sucesso!';
$LNG['ga_selectplanettype']				= 'Seleciona um planeta!';
$LNG['ga_definetarget']					= 'Definir Alvo';
$LNG['ga_planettypes']					= 'Tipo de Planeta';
$LNG['ga_homecoordinates']				= 'Apenas Planeta Principal';
$LNG['ga_no_inactives']					= 'Apenas jogadores ATIVOS<br>Não será oferecido aos jogadores inativos';
